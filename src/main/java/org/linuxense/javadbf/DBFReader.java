...
//import com.richeninfo.common.util.StringUtils;
...
public class DBFReader extends DBFBase {
     ...
     */
    public DBFReader(InputStream in, String charset) throws DBFException {
                    ...
                    case 'N':
                        ...
                        try {
                            ...
                            if (t_numeric.length > 0 && !Utils.contains(t_numeric, (byte) '?')) {
                                String num = new String(t_numeric);
                                if (num.contains("-.") || num.equals("-")) {
                                    num = num.replace("-", "0");
                                }
                                recordObjects[i] = new Double(num);
                            } else {
