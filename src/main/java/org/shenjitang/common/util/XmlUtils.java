...
public class XmlUtils {
	...
	public String getTagValue(String xml, String locateTagName,
			String locateTagValue, String tagName) throws Exception {
	...
	public void getTagValue(Element element, String locateTagName,
			String locateTagValue, String tagName, StringBuffer result) {
