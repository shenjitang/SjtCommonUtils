...
public class HttpClientUtil {
     ...
     * 创建代理的HttpClient
     */
    public static HttpClient createProxyHttpClient(String host, int port, String username, String password) {
        HttpClient client = createDefaultHttpClient();
        client.getHostConfiguration().setProxy(host, port);
        client.getParams().setAuthenticationPreemptive(true);
        client.getState().setProxyCredentials(new AuthScope(host, AuthScope.ANY_PORT, AuthScope.ANY_REALM), new UsernamePasswordCredentials(username, password));
        return client;
    }
     ...
     * get提交
     */
    public static String get(HttpClient client, String url, Map<String, String> headerMap) {
     ...
     * post提交
     */
    public static String post(HttpClient client, String url, Map<String, String> headerMap, Map<String, String> paramMap) {
        String responseString = "";
    ...
    private static NameValuePair[] getParameterArray(Map<String, String> paramMap) {
